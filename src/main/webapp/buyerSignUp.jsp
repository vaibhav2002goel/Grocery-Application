...
<body>
	...
	<%@ include file="./header/BuyerSignUpHeader.html" %>
	<div class="bg">
	
	<div class="signupFrm">
    <form action="buyerValidationAndInsertion" method="post" class="form">
      ...
      <div class="inputContainer">
        <input name="address" id="address" type="text" class="input" placeholder="a" required>
...
<!--   <script type="text/javascript" src="./javascript/buyerValidation.js"></script> -->
  <script>
