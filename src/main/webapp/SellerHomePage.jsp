...
<body>
	...
	<div class="bg">
	    ...
	    <%!
			...
			String query1 = "select * from REPOSITORY where SellerUsername=? AND ProductCategory=?";
	    %>
...
// 			String username = (String) session.getAttribute("username");
		...
		%>
	       	...
	       	<div class="seven">
				<h1 style="font-weight:1000;font-size:50px;padding:20px;color:lightBlue;text-decoration:underline ;" class="h1_1" id="oils" >OILS</h1><br><br>
	       	</div>
			<div id="items">
		<%
			while(rs3.next()){
...
// 			String username = (String) session.getAttribute("username");
		...
		%>
	       	...
	       	<div class="seven">
			<h1 style="font-weight:1000;font-size:50px;padding:20px;color:lightBlue;text-decoration:underline ;" class="h1_1" id="dairy">DAIRY</h1><br><br>
	       	</div>
			<div id="items">
		<%
			while(rs4.next()){
...
//			String username = (String) session.getAttribute("username");
		...
		%>
			...
			<div class="seven">
			<h1 style="font-weight:1000;font-size:50px;padding:20px;color:lightBlue;text-decoration:underline ;" class="h1_1" id="others" >OTHERS</h1><br><br>
			</div>
			<div id="items">
		<%
			while(rs5.next()){
