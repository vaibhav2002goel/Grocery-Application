                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="font-size:25px;">:</td>
                            <td style="font-size:25px;"><%= (String) session.getAttribute("address") %></td>
                        </tr>
            	  ...
            	  <div class="card-body">
	            	...
	            	<form action="UpdateBuyerAndVerification" method="post">
		                <table>
		                    <tbody>
		                        <tr>
		                        ...
		                        <tr>
									<th style="font-size:25px;"><label for="address">New Address</label></th>
		                            <td style="font-size:25px;">:</td>
		                            <td style="font-size:25px;"><input type="text" name="address" id="address" required ></td>
		                        </tr>
